...
function Sort() {
  ...
  return (
    ...
    >
      ...
      />
      {isOpen && (
        <ul className="absolute grid self-center mt-80 bg-white w-56 right-56 rounded-md shadow-md  py-3">
          <li className="flex items-center border border-t-0 border-b-Line1/30 px-6 pb-3">
            <div className="flex items-center gap-5">
              <TbSortDescending className="text-BgBlue" />
              <span className="text-Line2 text-base font-normal">Terbaru</span>
            </div>
          </li>
          <li className="flex items-center border border-t-0 border-b-Line1/30 px-6 py-3">
            <div className="flex items-center gap-5">
          ...
          <li className="flex items-center  px-6 pt-3">
            <div className="flex items-center gap-5">
